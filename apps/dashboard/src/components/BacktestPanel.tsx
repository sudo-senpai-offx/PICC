        ...
        <div className="stack">
          <div className="grid grid-4">
            <Card className="pad">
              ...
              <div className="stat-value" style={{ color: result.hitRate > 0.5 ? "var(--gain)" : "var(--loss)" }}>{fmtPct(result.hitRate)}</div>
              <div className="muted small">{result.sampleSize} windows</div>
            </Card>
            <Card className="pad">
              <div className="stat-label muted">Return</div>
              <div className="stat-value" style={{ color: result.returnPct >= 0 ? "var(--gain)" : "var(--loss)" }}>
                  ...
                  <tbody>
                    {result.trades.map((t) => (
                      <tr key={t.model}>
                        ...
                        <td style={{ color: (t.hitRate ?? 0) > 0.5 ? "var(--gain)" : "var(--loss)" }}>{fmtPct(t.hitRate)}</td>
                        <td>{t.n}</td>
                        <td>
