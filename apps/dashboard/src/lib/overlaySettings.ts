...
export const SUITE_DOCKABLES: Record<string, DockableConfig[]> = {
  trading: [
    ...
    { id: "entry-points", title: "Buy/Sell Points", icon: "🎯", defaultPosition: "left", defaultSize: { width: 280, height: 300 }, defaultOpacity: 0.92, defaultCollapsed: false, description: "Ideal buy/sell zones with live mini-chart, hover crosshair and one-click simulation" },
    { id: "model-matrix", title: "Model Matrix", icon: "🧬", defaultPosition: "right", defaultSize: { width: 270, height: 280 }, defaultOpacity: 0.92, defaultCollapsed: true, description: "Multiplexing multi-model consensus with adaptive weights, per active asset" },
