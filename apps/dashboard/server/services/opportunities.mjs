...
export const OPPORTUNITY_CATALOG = [
  ...
  { id: "d-nft", category: "D", title: "NFT floor / royalty tracking", description: "Browser connectors read OpenSea / Magic Eden floor + volume; the studio browser overlays live page reads.", whatItAutomates: "Floor-price and royalty visibility without an API.", integrations: ["connectors", "studio overlay"], effort: "low", expectedValue: "Better timing", verified: true, sourceUrl: "https://opensea.io", status: "ready" },
  ...
  { id: "g-lmstudio", category: "G", title: "Local LLM (LM Studio)", description: "Run models locally for zero API cost; use as the LLM provider for PICC helpers and crews.", whatItAutomates: "Offline reasoning for PICC helpers.", integrations: ["LM Studio"], effort: "low", expectedValue: "No API spend", verified: true, sourceUrl: "https://lmstudio.ai", status: "ready" }
]
